...
class VOC12ClsDataset_SelfSup(VOC12ImageDataset_SelfSup):
    ...
    def __getitem__(self, idx):
        ...
        name2, img2 = super().__getitem__(idx2)
        ...
        if self.flag_asym_crop:
            ...
            img_A2,img_vgg2,_ = self.apply_tf(img2, rc='A')

        else:
            img_A,img_ori,_ = self.apply_tf(img)
            img_A2,img_ori2,_ = self.apply_tf(img2)
