...
if __name__ == '__main__':
    ...
    parser.add_argument("--cam_network", default="net.resnet38d", type=str)
    ...
    parser.add_argument("--cam_weights_name", default="sess/039net_main", type=str)
    ...
    if args.eval_cam_pass is True:
        import step.eval_cam_2

        timer = pyutils.Timer('step.eval_cam:')
        step.eval_cam_2.run(args)
