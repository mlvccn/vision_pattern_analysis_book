...
from modules.transformer_v1 import *
...
class P4Transformer(nn.Module):
    def __init__(self, radius, nsamples, spatial_stride,                               
        ...
        self.tube_embedding = P4DConv(in_planes=0, mid_planes=dim, out_planes=80,
                                  spatial_kernel_size=[radius, nsamples], 
                                  temporal_kernel_size=temporal_kernel_size, spatial_stride=spatial_stride, temporal_stride=temporal_stride, temporal_padding=[1, 0], 
                                  spatial_pooling='max')
