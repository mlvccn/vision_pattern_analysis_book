...
parser.add_argument('--input_dir', default='data/MSR/Depth', help='Depth directory for input [default: Depth]')
parser.add_argument('--output_dir', default='data/MSR/point', help='Output processed data directory [default: processed_data]')
parser.add_argument('--num_cpu', type=int, default=4, help='Number of CPUs to use in parallel [default: 4]')
