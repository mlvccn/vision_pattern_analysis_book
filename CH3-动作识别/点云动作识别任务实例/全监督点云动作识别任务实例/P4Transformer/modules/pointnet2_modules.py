...
class _PointnetSAModuleBase(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor,
                features: torch.Tensor = None) -> (torch.Tensor, torch.Tensor): # type: ignore
        r"""
        Parameters
        ----------
        xyz : torch.Tensor
...
class PointnetSAModuleVotes(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor,
                ...
                inds: torch.Tensor = None) -> (torch.Tensor, torch.Tensor): # type: ignore
        r"""
        Parameters
        ----------
        xyz : torch.Tensor
...
class PointnetSAModuleMSGVotes(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor,
                features: torch.Tensor = None, inds: torch.Tensor = None) -> (torch.Tensor, torch.Tensor): # type: ignore
        r"""
        Parameters
        ----------
        xyz : torch.Tensor
