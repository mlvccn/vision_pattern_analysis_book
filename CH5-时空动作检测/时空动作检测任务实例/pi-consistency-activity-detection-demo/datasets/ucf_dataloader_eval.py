...
import pickle
import cv2
from datasets.path import ucf101_dataset_dir, ucf101_annot_base_path
...
class UCF101DataLoader(Dataset):
    ...
    def __init__(self, name, clip_shape, batch_size, file_id, use_random_start_frame=False):
      self._dataset_dir = ucf101_dataset_dir
    ...
    def get_det_annots_prepared(self, file_id):
        ...
        training_annot_file = ucf101_annot_base_path + file_id
    ...
    def get_det_annots_test_prepared(self, file_id):
        import pickle    
        testing_anns  = ucf101_annot_base_path + file_id
