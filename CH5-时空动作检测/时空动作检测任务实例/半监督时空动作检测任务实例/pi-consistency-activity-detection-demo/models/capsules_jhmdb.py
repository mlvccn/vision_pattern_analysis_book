...
class CapsNet(nn.Module):
    ...
    def __init__(self, pt_path='weights/rgb_charades.pt', P=4, pretrained_load='i3d'):
        ...
        self.conv_caps = ConvCaps(32, 21, (1, 1), P, stride=(1, 1), iters=3) # jhmdb21
    ...
    def forward(self, img, classification, concat_labels, epoch, thresh_ep):
        ...
        if self.training:
            # activations_labeled = torch.eye(caps)[classification.long()]  # 修改
            ...
            if epoch<thresh_ep:
                ...
                activations_unlabeled = torch.eye(caps).cuda()[torch.argmax(actor_prediction, dim=1)]
