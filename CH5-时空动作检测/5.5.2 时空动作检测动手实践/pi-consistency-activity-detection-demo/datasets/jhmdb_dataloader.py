...
from datasets.path import jhmdb_dataset_dir, jhmdb_mask_dir, jhmdb_annot_base_path
'''
...
class JHMDB(Dataset):
    def __init__(self, name, clip_shape, file_id, use_random_start_frame=False):
      ...
      self._dataset_dir = jhmdb_dataset_dir
    ...
    def get_det_annots_prepared(self, file_id):
        training_annot_file =  jhmdb_annot_base_path + file_id
    ...
    def get_det_annots_test_prepared(self, file_id):
        test_annot_file = jhmdb_annot_base_path + file_id
