...
for attack_type  in attack_types:
    ...
    data_query = []
    save_path = "./results/adv_img_attr/minigpt_toxic/{}".format(attack_type)
    for index, image in enumerate(image_list):
        ...
        for i in range(3):
            ...
            ImgAttr.init_image_query(image, query, num_ablations=96, ablation_keep_prob=0.50) 
    ...
    data.to_csv('./results/queries/minigpt_toxic_{}.csv'.format(attack_type), index=False)
